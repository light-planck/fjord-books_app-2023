...
ActiveRecord::Schema[7.0].define(version: 2023_12_14_073220) do
  ...
  create_table "report_mentions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["mentioned_id", "mentioning_id"], name: "index_report_mentions_on_mentioned_id_and_mentioning_id", unique: true
